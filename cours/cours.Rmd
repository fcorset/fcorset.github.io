...
1. Le biais de $T$ est la différence entre l'espérance de $T$ et la vraie valeur (inconnue) de $\theta$ : Biais=$\E[T]-\theta$.
2. L'erreur quadratique est l'espérance des carrés des différences : QE= $\E[(T-\theta)^2]$.
...
** Problème :** Peut-on trouver deux statistiques $T_1$ et $T_2$
