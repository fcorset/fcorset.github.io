...
où $n!=n\times(n-1)\times(n-2)\times\ldots\times 2\times 1$ et $0!=1$.
...
```{r}
curve(pbinom(x,size=10,prob = 0.3),type="S",from = -1,to=11,ylab="y", main=" Fonction de répartition de la loi binomiale B(10,0.3)")
```
